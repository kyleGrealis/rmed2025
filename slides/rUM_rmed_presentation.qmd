...
:::{.fragment}
Do you see different results when you try to repeat the results from a paper using a new, independent sample?
...
![](../snagit/kyle.jpg){.styled-image .absolute bottom="40%" right="0%" height="auto" width="200"}
